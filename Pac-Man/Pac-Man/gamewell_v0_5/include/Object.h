...
public:
	...
	Object(const ImageID* const id, int x, int y, int width, int height, bool shoulddraw);
	...
	///Scales the width negatively to flip the rendering
	virtual void FlipHorizontal();

	///Scales the height negatively to flip the rendering
...
protected:
    ...
    /// This should stay protected. You should not attempt to copy this.
	ImageID* m_imageIDs;
